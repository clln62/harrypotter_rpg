...
GAME OVER
        ...
        print_text.print_text("Your spell works, confusing the basilisk and causes it to move in a different direction.")
        if 'sword' in inventory:
            print_text.print_text("""
Will you cast another spell, or will you brandish your sword?
Enter "A" for spell.
...
"B" to face the basilisk head on.
            ...
            if answer == 'A':
                print_text.print_text("You make a run for it, barely clearing the next room before the basilisk hits the wall.")
                sword_winning(player)
            else:
                print_text.print_text("""
